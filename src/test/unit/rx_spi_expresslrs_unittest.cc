...
extern "C" {
    ...
    bool sx1280GetFrequencyErrorbool(void) { return true; }
    void sx1280SetPPMoffsetReg(const int32_t , const uint32_t ) {}
    ...
    int8_t sx127xGetLastPacketRSSI(void) { return 0; }
    int8_t sx127xGetLastPacketSNR(void) { return 0; }
    bool sx127xGetFrequencyErrorbool(void) { return true; }
    void sx127xSetPPMoffsetReg(const int32_t , const uint32_t ) {}
    bool sx127xInit(IO_t ) { return true; };
