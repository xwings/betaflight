...
static void calculateThrottleAndCurrentMotorEndpoints(timeUs_t currentTimeUs)
{
    ...
    if (mixerRuntime.feature3dEnabled) {
        ...
        motorRangeMax = isFlipOverAfterCrashActive() ? DSHOT_MAX_THROTTLE : mixerRuntime.motorOutputHigh - motorRangeAttenuationFactor * (mixerRuntime.motorOutputHigh - mixerRuntime.motorOutputLow);
#else
        motorRangeMax = mixerRuntime.motorOutputHigh;
#endif
